...
import { Row, Col, Space, Tag, Upload, Button, Modal, Radio, message } from 'antd'
...
export default class index extends Component {
    ...
    state = {
        ...
        identity:['expert','assistant','teacher'][this.randomNum(0,2)],        //控制当前用户身份 expert专家/助理/teacher教师
